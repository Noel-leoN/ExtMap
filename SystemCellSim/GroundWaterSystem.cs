...
namespace ExtMap57km.Systems
{
	...
	public partial class GroundWaterSystem : CellMapSystem<GroundWater>, IJobSerializable
	{
		...
		public static GroundWater GetGroundWater(NativeArray<GroundWater> groundWaterMap, int2 cell)
        {
		...
		//make public;
		public static void SetGroundWater(NativeArray<GroundWater> groundWaterMap, int2 cell, GroundWater gw)
		{
			if (GroundWaterSystem.IsValidCell(cell))
			{
        ...
        //make public for harmony easy;
        public static float Bilinear(short v00, short v10, short v01, short v11, float sx, float sy)
